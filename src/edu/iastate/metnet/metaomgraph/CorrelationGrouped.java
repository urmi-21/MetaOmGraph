...
public class CorrelationGrouped {
	...
	public double doComputation() throws InterruptedException, ExecutionException {
		...
		//JOptionPane.showMessageDialog(null, "r for groups"+ Arrays.toString(finalRes));
		// return the p value
		...
		double rval=getrvalueRandModel(finalRes, gSize);
		return rval;
	}
	 ...
	 * @return
	 */
	private static double getrvalueFEModel(double [] corrvals,int [] groupSizes) {
	...
	private static double getrvalueRandModel(double [] corrvals,int [] groupSizes) {
	...
	public static void main(String[] args) {
		...
		System.out.println("pooldr:"+getrvalueFEModel(corrvals,groupSizes));
		System.out.println("..........");
		System.out.println("RAND pooldr:"+getrvalueRandModel(corrvals,groupSizes));
