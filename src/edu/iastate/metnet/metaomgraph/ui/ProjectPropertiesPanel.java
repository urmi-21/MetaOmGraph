...
public class ProjectPropertiesPanel
    ...
    public ProjectPropertiesPanel(MetaOmProject activeProject) {
        this(activeProject, activeProject.getDefaultXAxis(), activeProject.getDefaultYAxis(), activeProject.getDefaultTitle(), activeProject.getColor1(), activeProject.getColor2());
    }

    private ProjectPropertiesPanel(MetaOmProject project, String x, String y, String title, Color color1, Color color2) {
        myProject = project;
        ...
        public void manageRows() {
            ...
            defaultButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent arg0) {
                    ...
                    model.setColumnName(defaultColumn, model
                            .getColumnName(defaultColumn) +
                            "*");
                    myTable = new JTable(model);
                    myTable.setColumnSelectionAllowed(true);
                    myTable.setRowSelectionAllowed(false);
            ...
            okButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent arg0) {
                    ...
                    MetaOmGraph.getActiveTable().getSorter().setSortingStatus(
                            defaultColumn, 1);
                    f.dispose();
                }
        ...
        private class RowImportListener implements ActionListener {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    if (makeLocus) {
                        String[][] newInfoArray =
                                MetNetUtils.getMetNetInfo(newNameArray);
    ...
    private class ColumnManager {
        ...
        public void manageCols() {
            ...
            model = new NoneditableTableModel(tableData,
                    new String[]{"Name"});
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == 27) {
                    ...
                    for (int x = 0; (x < myTable.getRowCount()) && (!done); x++) {
                        if (model.getData()[((start + x) % myTable.getRowCount())][0].toString().toUpperCase().indexOf(tempBuffer) >= 0) {
                            buffer = tempBuffer;
                            myTable.changeSelection((start + x) %
                                    myTable.getRowCount(), 0, false, false);
                            done = true;
                        }
                    }
                    if (!done) {
