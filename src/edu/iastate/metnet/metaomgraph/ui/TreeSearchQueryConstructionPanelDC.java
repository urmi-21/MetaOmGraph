...
public class TreeSearchQueryConstructionPanelDC extends JPanel
		implements ActionListener, HashLoadable<TreeSearchQueryConstructionPanelDC.QuerySet> {
	...
	public TreeSearchQueryConstructionPanelDC(MetaOmProject project) {
	 ...
	 */
	public TreeSearchQueryConstructionPanelDC(MetaOmProject project, boolean searchDataTable, String [] columns) {
