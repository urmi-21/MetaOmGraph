...
public class FeatureMetadataRemoveCols extends JDialog {
	...
	public FeatureMetadataRemoveCols getThisframe() {
		return this;
	}
	 ...
	 * Create the frame.
	 */
	public FeatureMetadataRemoveCols(String[] headervals, MetadataCollection obj, ReadMetadata p) {
		setModal(true);
	...
	public FeatureMetadataRemoveCols(String[] headervals, MetadataCollection obj, MetaOmTablePanel p,
			boolean permanent) {
