...
public class ExpressionFilterConstructionPanel extends JPanel
    ...
    public ExpressionFilterConstructionPanel(MetaOmProject project) {
        ...
        maxDesc = new JLabel("Number of Samples with Min Expression: ", SwingConstants.RIGHT);
        ...
        minTotalDesc = new JLabel("Min Total Expression Count (Optional): ", SwingConstants.RIGHT);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ("filter".equals(e.getActionCommand())) {
            ...
            maxDesc.setText("Number of Samples with Min Expression: ");
