 ...
 * Differential Expression Analysis frame. Users can choose the features
 * that can go into a list and click on 'OK' to create the list with a 
 * particular name.
 * 
...
public class CreateListFrameDEA
    ...
    private CreateListFrameDEA myself;
    private boolean editList=false;

    public CreateListFrameDEA(MetaOmProject project) {
        this(project, null, null);
    }


    public CreateListFrameDEA(MetaOmProject project, String listName, logFCResultsFrame DEAObj) {
        myself = this;
      ...
      //urmi changed
        ...
        if (listName != null) {
            ...
            editList = true;
                ...
                activeEntries = DEAObj.getSelectedRowsIndices();
