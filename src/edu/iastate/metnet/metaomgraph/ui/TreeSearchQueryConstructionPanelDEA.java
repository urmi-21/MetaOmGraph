...
public class TreeSearchQueryConstructionPanelDEA extends JPanel
		implements ActionListener, HashLoadable<TreeSearchQueryConstructionPanelDEA.QuerySet> {
	...
	public TreeSearchQueryConstructionPanelDEA(MetaOmProject project) {
		this(project,false, project.getMetadataHybrid().getMetadataHeaders());
	 }
	 ...
	 */
	public TreeSearchQueryConstructionPanelDEA(MetaOmProject project, boolean searchDataTable, String [] columns) {
